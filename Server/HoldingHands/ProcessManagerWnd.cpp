...
void CProcessManagerWnd:: OnColumClick(NMHDR*pNMHDR, LRESULT * pResult)
{
	...
	{
	case 0:
		m_ProcessList.SortItemsEx(CompareByName, (DWORD_PTR)this);
		break;
	case 1:
		m_ProcessList.SortItems(CompareByPid, (DWORD_PTR)this);
		break;
	case 2:
		m_ProcessList.SortItemsEx(CompareByPPid, (DWORD_PTR)this);
		break;
	case 3:
		m_ProcessList.SortItemsEx(CompareByUser, (DWORD_PTR)this);
		break;
	case 4:
		m_ProcessList.SortItemsEx(CompareByCPU, (DWORD_PTR)this);
		break;
	
	case 6:
		m_ProcessList.SortItemsEx(CompareByHandle, (DWORD_PTR)this);
		break;
	case 7:
		m_ProcessList.SortItemsEx(CompareByThread, (DWORD_PTR)this);
		break;
	default:
		break;
	}
