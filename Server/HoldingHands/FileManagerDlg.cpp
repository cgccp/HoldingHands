...
void CFileManagerDlg::OnLvnColumnclickList1(NMHDR *pNMHDR, LRESULT *pResult)
{
	...
	*pResult = 0;
	...
	{
	case 0:
		m_FileList.SortItemsEx(CompareByName, (DWORD_PTR)this);
		break;
	case 1:
		m_FileList.SortItemsEx(CompareByType, (DWORD_PTR)this);
		break;
	case 3:
		m_FileList.SortItemsEx(CompareByDate, (DWORD_PTR)this);
		break;
	case 4:
		m_FileList.SortItemsEx(CompareByFreeSize, (DWORD_PTR)this);
	default:
		break;
	}
}
