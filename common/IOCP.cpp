...
BOOL CIOCP::PostRecv(CIOCPSocket * sock,BYTE * lpData,UINT   Size,LPOVERLAPPED lpOverlapped)
{
	//Post Recv
	WSABUF			wsabuf;
	INT32			nRet;
...
BOOL CIOCP::PostSend(CIOCPSocket * sock,BYTE * lpData,UINT Size,LPOVERLAPPED lpOverlapped)
{
	//Post Recv
	WSABUF			wsabuf;
	INT32			nRet;
	...
	nRet = WSASend(	hSock,	&wsabuf,1,NULL,flag,lpOverlapped,NULL);
...
BOOL CIOCP::PostSendTo(CIOCPSocket * sock,BYTE * lpData,UINT Size,const SOCKADDR* lpTo,int iTolen,LPOVERLAPPED lpOverlapped)
{
	//Post Recv
	WSABUF			wsabuf;
	INT32			nRet;
	...
	nRet = WSASendTo(hSock,&wsabuf,1,NULL,flag,lpTo,iTolen,lpOverlapped,NULL);
...
BOOL CIOCP::PostRecvFrom(CIOCPSocket * sock,BYTE * lpData,UINT Size,SOCKADDR* lpFrom,int* lpFromLen,LPOVERLAPPED lpOverlapped)
{
	//Post Recv
	WSABUF			wsabuf;
	INT32			nRet;
	...
	nRet = WSARecvFrom(hSock,&wsabuf,1,NULL,&flag,lpFrom,lpFromLen,lpOverlapped,NULL);
...
BOOL CIOCP::PostAccept(CIOCPSocket * sock,SOCKET hClientSocket,BYTE   * AddrBuf,UINT   * lpRecvBytes,
	UINT  LocalAddrLength,UINT  RemoteAddrLength,LPOVERLAPPED lpOverlapped)
{
	INT				iResult = 0;
...
BOOL CIOCP::PostConnect(CIOCPSocket * sock,const SOCKADDR* Addr,int iAddrLen,LPOVERLAPPED lpOverlapped)
{
	INT				iResult = 0;
	...
	nRet = lpfnConnectEx(hSock,(SOCKADDR*)Addr,iAddrLen,NULL,0,NULL,lpOverlapped);
