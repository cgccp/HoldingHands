...
public:
	...
	BOOL PostRecv(CIOCPSocket * sock,BYTE * lpData,UINT Size,LPOVERLAPPED lpOverlapped);

	BOOL PostSend(CIOCPSocket * sock,BYTE * lpData,UINT   Size,LPOVERLAPPED lpOverlapped);

	BOOL PostSendTo(CIOCPSocket * sock,BYTE * lpData,UINT Size,const SOCKADDR* lpTo,int iTolen,LPOVERLAPPED lpOverlapped);

	BOOL PostRecvFrom(CIOCPSocket * sock,BYTE * lpData,UINT Size,SOCKADDR* lpFrom,int* lpFromLen,LPOVERLAPPED lpOverlapped);

	BOOL PostAccept(CIOCPSocket * sock,SOCKET hClientSocket,BYTE   * AddrBuf,UINT   * lpRecvBytes,UINT  LocalAddrLength,
		UINT  RemoteAddrLength,LPOVERLAPPED lpOverlapped);

	BOOL PostConnect(CIOCPSocket * sock,const SOCKADDR* Addr,int iAddrLen,LPOVERLAPPED lpOverlapped);
