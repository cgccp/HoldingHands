...
void CTCPSocket::cb_read(TCP_READ_OVERLAPPED *lpOverlapped, UINT32 nTransferredBytes, DWORD Error)
{
...
//Async Recv.
BOOL CTCPSocket::Recv(UINT8* lpData, UINT32 Size, UINT * lpRecvBytes, void * lpParam,HANDLE hEvent)
{
	BOOL bRet = FALSE;
...
BOOL CTCPSocket::Send(BYTE * lpData, UINT32 Size,UINT *lpSendBytes,void * lpParam,HANDLE hEvent)
{
	BOOL bRet = FALSE;
