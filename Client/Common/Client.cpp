...
//需要做 On Close.
void CClient::OnRecv(BYTE * lpData,UINT32 nTransferredBytes,void * lpParam,DWORD Error)
{
	UINT32 newSize;
...
void CClient::OnSend(BYTE * lpData, UINT32 nTransferredBytes, void * lpParam, DWORD Error)
{
}
